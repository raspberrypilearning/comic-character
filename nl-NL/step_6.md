...
<iframe src="https://editor.raspberrypi.org/nl-NL/embed/viewer/comic-character-step6?page=character.html" width="100%" height="800" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
...
Begin met het eerste veld, `characterName`, welke het HTML-element bevat met het attribuut `id="name-text"`.
