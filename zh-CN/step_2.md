...
<iframe src="https://editor.raspberrypi.org/zh-CN/embed/viewer/comic-character-step2" width="100%" height="800" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
...
打开 [漫画人物入门项目](https://editor.raspberrypi.org/zh-CN/projects/comic-character-starter){:target="_blank"}.
...
这个项目已经包含了一个导航栏和一个首页横幅，你已经在[欢迎来到南极洲](https://projects.raspberrypi.org/zh-CN/projects/welcome-to-antarctica)中学会了如何创建他们。
