...
---
      ...
      <div class="hero-container">
        <div class="hero-slider">
          ...
          <span class="hero-slide"><img src="safina-cape.jpg" alt="A一位黑发超级英雄，身穿红白相间的服装和蓝色斗篷，背景为蓝色和黄色。"></span>
          <span class="hero-slide"><img src="layton-slider.jpg" alt="蓝色背景前，一位金发超级英雄，身穿蓝色服装和红色斗篷。"></span>
          <span class="hero-slide"><img src="kwame-cape.jpg" alt="一位身穿超级英雄服装的超级英雄人物骄傲地站在雄伟的山脉前。"></span>
          <span class="hero-slide"><img src="ellenhero-image.jpg" alt="一位身穿红色斗篷和蓝色衬衫的超级英雄站在山前。"></span>
      </div>
...
<iframe src="https://editor.raspberrypi.org/zh-CN/embed/viewer/comic-character-upgrade" width="100%" height="800" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>

你可以在此处查看 [升级后的项目文件](https://editor.raspberrypi.org/zh-CN/projects/comic-character-upgrade){:target="_blank"}。
