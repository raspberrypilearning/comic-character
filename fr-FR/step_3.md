...
<iframe src="https://editor.raspberrypi.org/fr-FR/embed/viewer/comic-character-step3?page=character.html" width="100%" height="800" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
...
<br>`<input type="radio" name="meal"> <label>Petit déjeuner</label>`
<br>`<input type="radio" name="meal"> <label>Déjeuner</label>`
<br>*Essaie-le* :
<br><input type="radio" name="meal"><label>Petit déjeuner</label>
<br><input type="radio" name="meal"><label>Déjeuner</label>
...
<br>`<select><option value="Water">Eau</option><option value="Juice">Jus</option></select>`
<br>*Essaie-le* :
<br><select><option value="Water">Eau</option><option value="Juice">Jus</option></select>
...
<br>*Essaie-le* : <br><textarea></textarea>
