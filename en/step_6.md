...
Give it the id "captchaSection", a class of "center-container" and the function attribute onload that calls the function "generate()".
...
To be able to submit the captcha, you need an <input> element to check against the code generated by your "generate()" function.
...
Add a "text" type <input> element with the id "submit" and a placeholder with the text " Enter Captcha code", wrapped by a <span> tag. Give the <span> element the id "user-input" and class "inline".
